...
EASS.Persistor.writeMarkerArrayToLayerMarkers = function (markerArray, targetLayer) {
	this.writeMarkerArrayToProperty(markerArray, targetLayer.property("Marker"));
}
...
EASS.Persistor.writeMarkerArrayToCompositionMarkers = function (markerArray, targetComp) {
	...
	this.writeMarkerArrayToProperty(markerArray, targetComp.property("Marker"));
}

/** @function writeMarkerArrayToProperty
 ...
 *  @param {AVLayer} targetLayer - Target layer.
 */
 EASS.Persistor.writeMarkerArrayToProperty = function (markerArray, targetProp) {
